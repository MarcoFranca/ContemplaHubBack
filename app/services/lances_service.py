    ...
    *,
    ...
    for cota in rows:
        ...
        items.append({
            ...
            "taxa_admin_percentual": cota.get("taxa_admin_percentual"),
            "taxa_admin_valor_mensal": cota.get("taxa_admin_valor_mensal"),
            ...
            "forma_pagamento": cota.get("forma_pagamento"),
